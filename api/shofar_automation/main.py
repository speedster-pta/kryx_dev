...
from shofar_automation.integrations.webhooks import router as webhook_router
from shofar_automation.admin import setup_admin
from shofar_automation.admin_auth import ScopeCleanupMiddleware
from starlette.middleware.sessions import SessionMiddleware
from shofar_automation.auth import require_admin_key
from shofar_automation.clients import close_clients
from shofar_automation.config import settings
from shofar_automation.core.db_init import init_db
from shofar_automation.scheduler import scheduler, reload_pending_campaigns, reload_serving_rules
from shofar_automation.services.registration_poller import poll_for_new_registrations
from shofar_automation import storage
from shofar_automation.storage.header_images import HEADER_IMAGES_DIR
from shofar_automation.utils.logging import get_logger
from shofar_automation.web.campaigns_router import router as campaigns_router
from shofar_automation.web.automations_router import router as automations_router
from shofar_automation.web import templates_router
from shofar_automation.web.recipient_import import router as recipient_import_router
from shofar_automation.web.numbers_router import router as numbers_router
from shofar_automation.web.onboarding_router import router as onboarding_router
from shofar_automation.web.account_router import router as account_router
