...
re-exported here so existing call sites (`from shofar_automation import
...
__all__ = [
    ...
    "REGISTRATION_TEMPLATE_TYPES",
    "get_unit_by_phone_id", "get_unit_by_slug", "get_active_units",
    ...
    "get_staff_user", "get_staff_user_by_id", "update_staff_password",
    "create_staff_user", "assign_staff_unit",
