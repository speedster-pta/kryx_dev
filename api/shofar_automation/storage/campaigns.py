...
def create_campaign(staff_user_id: int, unit_id: int, whatsapp_number_id: int,
    ...
    with _connect() as conn:
        cur = conn.execute(
            ...
            INSERT INTO campaigns
                (staff_user_id, unit_id, whatsapp_number_id, template_name, language,
...
def list_campaigns(unit_ids: list[int] | None, limit: int = 50) -> list[dict]:
    ...
    with _connect() as conn:
        base = """
            ...
            JOIN staff_users su ON su.id = c.staff_user_id
