...
Uses the graph API version pinned on shofar_automation.integrations.whatsapp
...
from shofar_automation.integrations.whatsapp import BASE_URL as _ASYNC_BASE_URL
